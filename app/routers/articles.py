...
from model.article import ArticleSynopsisDTO, ArticlesDTO, CreateArticle, ArticleDTO, UpdateArticle
...
@router.get("/synopsis", response_model=list[ArticleSynopsisDTO])
def get_all_articles_synopsis(
  session: SessionDep,
):
